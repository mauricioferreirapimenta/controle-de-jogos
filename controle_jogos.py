...
if pagina == "➕ Adicionar Jogo":
    ...
    with st.form("form_adicionar"):
        ...
        console = ""
        if plataforma and plataforma in consoles_por_plataforma:
            console = st.selectbox("Console", [""] + consoles_por_plataforma[plataforma], key="add_console")
        else:
            st.selectbox("Console", [""], key="add_console_disabled", disabled=True)
...
# ------------------ OUTRAS PÁGINAS (manter anteriores) ------------------
