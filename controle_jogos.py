...
if pagina == "➕ Adicionar Jogo":
    ...
    with st.form("form_adicionar"):
        ...
        if plataforma:
            console_options = [""] + consoles_por_plataforma.get(plataforma, [])
            console = st.selectbox("Console", console_options, key="add_console")
        else:
            console = ""
...
# As demais páginas continuam inalteradas (Ver, Editar, Excluir, Lista Completa, Backup)
